...
cd web && npm test                           # Frontend + server vitest (169 tests)
...
536 Python CLI tests. 169 frontend + server vitest tests (98 frontend + 24 store + 21 route integration + 26 TTS).
