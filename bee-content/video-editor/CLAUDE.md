...
cd web && npm test                           # Frontend + server vitest (176 tests)
...
536 Python CLI tests. 176 frontend + server vitest tests (98 frontend + 24 store + 21 route integration + 26 TTS + 7 media-utils).
