...
import type { BeeProject } from './types/index.ts';
...
const Root: React.FC = () => {
  return (
    <Composition
      ...
      width={1920}
      height={1080}
      defaultProps={{ storyboard: null as unknown as BeeProject, mediaFiles: [] as string[], showCaptions: true, transitionMode: 'overlap' as const }}
