...
export const VISUAL_TYPE_MAP: Record<string, string> = {
  ...
  'NOTEPAD': 'NOTEPAD',
  'VIDEO_PLAYER': 'VIDEO_PLAYER', 'VIDEO-PLAYER': 'VIDEO_PLAYER',
  'MAP_ANNOTATION': 'MAP_ANNOTATION', 'MAP-ANNOTATION': 'MAP_ANNOTATION',
  'DRAMATIC_QUOTE': 'DRAMATIC_QUOTE', 'DRAMATIC-QUOTE': 'DRAMATIC_QUOTE',
  'PHONE_MOCKUP': 'PHONE_MOCKUP', 'PHONE-MOCKUP': 'PHONE_MOCKUP',
  'DESKTOP_MONTAGE': 'DESKTOP_MONTAGE', 'DESKTOP-MONTAGE': 'DESKTOP_MONTAGE',
